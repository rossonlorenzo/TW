...
INSERT INTO public.utenti(mail, password, nome, cv_path)
VALUES
...
INSERT INTO public.aziende (mail, password, nome, sito, fondazione, dipendenti, fatturato, sede, ambito, "desc")
VALUES
...
(
	...
	data_pub timestamp without time zone NOT NULL,
	ambito character varying(60) NOT NULL,
...
INSERT INTO public.offerte (titolo, locazione, data_pub, ambito, remoto, contratto, "desc_breve", "desc_completa", titoli_r, esperienza, paga_m, azienda_id)
VALUES
...
INSERT INTO public.candidate (utenti_id, offerte_id)
VALUES
    (1, 1), (1, 2),
    (2, 3), (2, 4),
    (3, 5), (3, 6),
...
(
    ...
    REFERENCES aziende (id) MATCH SIMPLE
    ON UPDATE CASCADE
    ON DELETE CASCADE
);
	 
INSERT INTO public.valutazioni (utenti_id, aziende_id, commento, voto)
VALUES
