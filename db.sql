...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
INSERT INTO offerte (titolo, locazione, data_pub, ambito, remoto, contratto, `desc_breve`, `desc_completa`, titoli_r, esperienza, paga_m, azienda_id)
VALUES
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
INSERT INTO preferiti (utenti_id, offerte_id)
VALUES
    (1, 1), (1, 2),
    (2, 3), (2, 4),
    (3, 5), (3, 6),
...
-- SQLINES LICENSE FOR EVALUATION USE ONLY
INSERT INTO candidate (utenti_id, offerte_id)
VALUES
    (1, 1), (1, 2),
    (2, 3), (2, 4),
    (3, 5), (3, 6),
