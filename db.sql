...
VALUES
    ...
    ('viva@ecoviva.it', 'cq`8;,PEZu', 'EcoViva', 'www.ecoviva.it', 2008, 600, 4500000, 'Napoli', 'Ambiente Sostenibile', 'EcoViva è all''avanguardia nella promozione di soluzioni sostenibili per un futuro ecologico. Specializzati in progetti ambientali, offriamo innovazioni eco-friendly per preservare il nostro pianeta. Unisciti a noi nella creazione di un mondo più pulito e sostenibile per le generazioni future.'),
    ...
    ('creativeit@creativeit.it', 'y)4@ATeaVL', 'Creative IT', 'www.creativeit.it', 2001, 900, 8000000, 'Roma', 'Design', 'Creative IT è un''azienda all''avanguardia nel mondo del design, unendo creatività e tecnologia. Offriamo soluzioni innovative per il web, il branding e l''esperienza utente. Con il nostro team di talentuosi designer, trasformiamo le idee in esperienze visive straordinarie, creando un impatto duraturo.'),
