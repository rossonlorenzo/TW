...
VALUES
    ...
    ('viva@ecoviva.it', 'cq`8;,PEZu', 'EcoViva', 'www.ecoviva.it', 2008, 600, 4500000, 'Napoli', 'Ambiente Sostenibile', 'EcoViva è all''avanguardia nella promozione di soluzioni sostenibili per un futuro ecologico. Specializzati in progetti ambientali, offriamo innovazioni che rispettano l''ambiente per preservare il nostro pianeta. Unisciti a noi nella creazione di un mondo più pulito e sostenibile per le generazioni future.', '../../assets/logos/5_logo.png'),
    ...
    ('itinnovazionetech@itinnovazionetech.it', 'y+2;,$V9<~', 'IT Innovazione Tech', 'www.itinnovazionetech.it', 2009, 850, 7200000, 'Roma', 'Innovazione Tecnologica', 'IT Innovazione Tech è il motore dell''evoluzione tecnologica. Con un focus su intelligenza artificiale, sviluppo di applicazioni e sicurezza informatica, siamo all''avanguardia nel plasmare il futuro digitale. Offriamo soluzioni innovative per aziende pronte a abbracciare il cambiamento.', '../../assets/logos/13_logo.png'),
...
VALUES
    ...
    'Sei un coordinatore di progetti dinamico? Entra a far parte del nostro team come Gestore Progetti. Sarai responsabile della pianificazione, esecuzione e monitoraggio delle attività di progetto. Cerchiamo un professionista motivato con capacità di guida, problem-solving e orientato ai risultati.',
